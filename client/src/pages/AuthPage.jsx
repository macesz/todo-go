...
export default function AuthPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          ...
          ${isSignUp ? 'translate-x-[100%] opacity-100' : 'opacity-0 z-0 pointer-events-none'}
          `}
                >
                    <SignUpForm />
                </div>
          ...
          ${isSignUp ? 'translate-x-[100%] opacity-0 z-0 pointer-events-none' : 'translate-x-0 opacity-100'}
          `}
                >
                    <LoginForm />
                </div>
